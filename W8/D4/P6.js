...
async function main() {
    ...
    // const result = await verifyOTP("123",userEnteredOtp); // No OTP
    // const result = await verifyOTP("user1"); // Invalid
    const result = await verifyOTP("user1",userEnteredOtp); // Expired
    console.log(result);

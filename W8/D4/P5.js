...
setTimeout(() => {
    console.log(verifyOTP("user1","132")); //Expired
}, 10000);

// console.log(verifyOTP("user1",userEnteredOtp)); //Valid
// console.log(verifyOTP("user1","132")); //Invalid
// console.log(verifyOTP("user2","132")); //No OTP
...
const MOVIES = [
    ...
    {id: 4, title: "Oppenheimer", genre: "Drama"},
    {id: 5, title: "Deadpool", genre: "Comedy"},
...
return(
    <section>
        <h2>Now showing</h2>
        {/* Search */}
        <input type="text" placeholder="Search Movies...." value={search} onChange={(event)=> {
        ...
        {/* Pagination */}
        {
            totalPages > 1 && (
                <div style={styles.pagination}>
                    <button style={styles.button} disabled={page === 1} onClick={() => {
                        setPage(prev => prev-1);
                    }}>Previous</button>

                    <span>Page {page} of {totalPages}</span>

                    <button style={styles.button} disabled={page === totalPages} onClick={() => {
                        setPage(prev => prev+1);
                    }}>Next</button>
                </div>
            )

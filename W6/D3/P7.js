...
//A buffer stores row bytes
//Here we create buffer directly from a string

const textBuffer = Buffer.from("Bindu");
...
//Each character is stored internally ad byte data for standard ASCII letters there will be a equivalent code

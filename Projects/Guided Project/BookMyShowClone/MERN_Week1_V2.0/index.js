...
function showMenu() {
  ...
  console.log("6. View saved bookings from file"); 
  console.log("7. View data directory files"); 
  console.log("8. Rename log file");
  console.log("9. Delete archived log file"); 
  console.log("10. Exit"); 
...
function handleMenuChoice(choice) {
  switch (choice.trim()) {
    ...
    case "3":
      ...
      break;
    case "4":
      cancelBooking(movies).then(() => showMenu()); 
      break;
    case "5":

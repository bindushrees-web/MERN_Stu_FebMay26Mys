...
const userToken = jwt.sign({userId:1, role:"user", email:"abc123@gmail.com"}, secretKey,{expiresIn:"1h"});
console.log("UserToken:",userToken);
const adminToken = jwt.sign({userId:2, role:"admin", email:"xyz123@gmail.com"}, secretKey,{expiresIn:"1h"});
...
app.get("/me",authenticateToken,function(req, res){
    res.json({ success: true, message: "Protected user route accessed.", user: req.user});
});
